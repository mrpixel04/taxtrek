...
// Force content to start below header image (same fix as bulk version)
$pdf->SetY(20);  // Start content at Y position 60 (well below the header)

// HTML table content - EXACT SAME structure as bulk_cetaknotisbm.php
$html = '
 <style>
